...
abstract class A11AbstractElement {
  ...
  def above(that: A11AbstractElement): A11AbstractElement =
    new A11ArrayElement(this.contents ++ that.contents)
...
class A11ArrayElement(private val conts: Array[String]) extends A11AbstractElement {

  override val contents: Array[String] = conts

}

class A11LineElement(s: String) extends A11AbstractElement {
